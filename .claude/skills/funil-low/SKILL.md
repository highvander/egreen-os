...
- `memoria/produto.md` — produto ativo, ticket, posicionamento, público
- `memoria/nicho.md` — nicho, avatar, dores, concorrentes
...
- Detalhes completos → leia `.claude/skills/funil-low/references/email-sequences.md`
...
- Setup completo → leia `.claude/skills/funil-low/references/traffic-setup.md`
...
Para estrutura detalhada de cada seção, leia `.claude/skills/funil-low/references/landing-page.md`.
...
Para roadmap completo semana a semana, leia `.claude/skills/funil-low/references/roadmap.md`.
...
- Estrutura detalhada da landing page → `.claude/skills/funil-low/references/landing-page.md`
- Roadmap semana a semana → `.claude/skills/funil-low/references/roadmap.md`
- Sequências de email completas → `.claude/skills/funil-low/references/email-sequences.md`
- Setup de tráfego Meta Ads → `.claude/skills/funil-low/references/traffic-setup.md`

Para configurar campanhas Meta Ads, use a skill `/trafego-criar-campanha`.
