...
em UMA tabela agrupada por formato, salva automaticamente em `02-pesquisa-mercado/`.
...
### Passo 2B. Salvar tabela em `02-pesquisa-mercado/`
...
```
✅ Salvo em: 02-pesquisa-mercado/YYYY-MM-DD-50-ideias-{slug}.md
```
