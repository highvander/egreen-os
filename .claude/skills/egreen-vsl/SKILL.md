...
{pasta-ativa}/memoria/nicho.md              → avatar, dores, objeções
{pasta-ativa}/memoria/produto.md            → produto, preço, promessa
{pasta-ativa}/memoria/funil.md              → oferta, bônus, garantia
...
2. **Introduzir o Vehicle** — o método com nome próprio, em oposição ao "jeito velho" que o público já tentou (reaproveitar objeções mapeadas em `nicho.md`).
...
4. **Stack e fechamento** — revelar oferta, empilhar valor item por item sem revelar preço antes do stack completo, revelar preço, bônus com urgência real (reaproveitar `funil.md`), fechar com objeções antecipadas.
...
- **P — Problem**: nomear o problema real (reaproveitar `nicho.md`), específico o suficiente pra reconhecimento imediato
...
- **O — Offer**: a oferta específica, sem ambiguidade (reaproveitar `funil.md`)
...
- Reaproveitar objeções reais já mapeadas em `nicho.md`/`egreen-pesquisa` na etapa de quebra de crença (Rota A) ou Amplify (Rota B), em vez de genéricas.
