...
description: >
  ...
  extensões e palavras-chave negativas. Lê contexto de memoria/nicho.md
  e memoria/produto.md. Salva em trafego-google/.
---

# /trafego-google — Estrutura de campanha Google Ads
...
- **Contexto do nicho:** `memoria/nicho.md` (nicho, público, posicionamento)
- **Contexto do produto:** `memoria/produto.md` (produto escolhido, preço, promessa)
...
Ler `memoria/nicho.md` e `memoria/produto.md` antes de perguntar qualquer coisa. Pular as perguntas já respondidas pela memória.
