...
A especificação técnica completa está em `.claude/skills/trafego-conexao/spec.md`.
...
Aplicar a seção **7. Saída final** do spec.md. Mostrar confirmação com o modo salvo e próximo passo recomendado (`/trafego-criar-campanha`).
