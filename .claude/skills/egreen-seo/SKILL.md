...
# /egreen-seo — Auditoria Completa de SEO, GEO e AEO
...
**Rodapé:** "EGreen OS — Relatório gerado automaticamente" alinhado à esquerda, número de página alinhado à direita. Separado por uma borda superior cinza.
...
Use nome de arquivo no padrão EGreen OS: `YYYY-MM-DD-seo-audit-dominio.docx`
