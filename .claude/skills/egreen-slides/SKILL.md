...
name: egreen-slides
description: >-
  Use quando o usuário quiser criar apresentação de slides, converter PPT/PPTX para web,
  ou gerar slides HTML animados para pitch, aula, lançamento ou palestra. Também dispara
  com "fazer slides", "criar apresentação", "montar deck", "apresentação do produto",
  "slides de vendas" ou qualquer variação de criação de slides visuais.
allowed-tools: Read, Write, Bash
model: sonnet
---

<!-- Skill original: frontend-slides por Zara Zhang (zarazhangrui)
     Repositório: https://github.com/zarazhangrui/frontend-slides
     Licença: MIT — LICENSE incluído nesta pasta -->

# Frontend Slides (Apresentação)
...
| [bold-template-pack/templates/*/egreen-design.md](bold-template-pack/templates/) | Detailed design-system docs for the selected bold template only | Phase 3 after user selection |
